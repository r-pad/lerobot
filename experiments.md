...
HF_HOME="/scratch/sskrishn/lerobot" nohup python lerobot/scripts/train.py --dataset.repo_id=sriramsk/fold_onesie_multiview_20251025_subsampled_heatmapGoal --policy.type=diffusion --output_dir=outputs/train/diffPo_multiview_foldOnesie_subsampled_heatmapGoal --job_name=diffPo_multiview_foldOnesie_subsampled --wandb.enable=true --policy.use_text_embedding=false --steps=300_000 --policy.crop_shape="[700, 700]" --policy.crop_is_random=true --policy.enable_goal_conditioning=true --batch_size=4 > foldOnesie_multiview_gc_diffPo.out &
```
