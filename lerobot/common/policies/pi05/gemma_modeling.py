...
# Adds AdaRMS (adaptive RMSNorm) and gated residuals required by PI0.5.
# Original: transformers/models/gemma/modeling_gemma.py
...
try:
    ...
    # LossKwargs not available or not a TypedDict in this transformers version
