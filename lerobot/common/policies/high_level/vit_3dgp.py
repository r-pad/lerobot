...
For maximum code reuse, we import FourierPositionalEncoding from dino_3dgp.
"""
...
from lerobot.common.policies.high_level.dino_3dgp import FourierPositionalEncoding
