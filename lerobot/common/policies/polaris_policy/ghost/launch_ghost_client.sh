CUDA_VISIBLE_DEVICES=0 python /home/haotian/lerobot/lerobot/scripts/control_robot.py \
    ...
    --control.repo_id=xiaochyVera/eval_ghost_test \
    ...
    --control.policy.local_policy_path="/home/haotian/lerobot/outputs/pick_place_red_mug_real_r40h0/checkpoints/last/pretrained_model"