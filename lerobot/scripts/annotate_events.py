...
TASK_SPEC = {
    ...
    "grasp hammer and strike the blue pin": ["grasp hammer", "strike the blue pin", "place hammer on table"],
    "grasp hammer and strike the pink pin": ["grasp hammer", "strike the pink pin", "place hammer on table"],
