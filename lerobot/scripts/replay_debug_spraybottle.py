...
# spraybottle
NONE_ABS_POLICY_ROOT = "~/Desktop/lerobot_restore/lerobot/outputs/train/real_spraybottle-dp3-none-abs_seed0/checkpoints/latest.ckpt"  # for loading policy config and checkpoints
GOAL_ABS_POLICY_ROOT = "~/Desktop/lerobot_restore/lerobot/outputs/train/real_spraybottle-dp3-goal-abs_seed0/checkpoints/latest.ckpt"
...
# spraybottle
GOAL_ABS_PRETRAIN_POLICY = "~/Desktop/lerobot_restore/lerobot/outputs/train/real_spraybottle-dp3-finetune-dummyaa_seed0/checkpoints/latest.ckpt"

# syringe
# DEFAULT_DATASET_ROOT = Path(
#     "~/.cache/huggingface/lerobot/YingYuan0414/syringe_0423_8"
# ).expanduser()
# spraybottle
DEFAULT_DATASET_ROOT = Path(
        ...
        for idx in range(0, 50 * len(actions), RUN_ACT_STEPS):
            ...
            for a_t in range(RUN_ACT_STEPS):
                ...
                if args.use_relative:
                    ...
                    WARMUP = 50 # 15                                                                                                                                                                                                                                                                     
                    GAIN = 1.0 + (1.3 - 1.0) * min(1.0, idx / WARMUP)      # 1.42       
