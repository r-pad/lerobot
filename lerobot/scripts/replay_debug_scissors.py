        ...
        while not flags.quit:
            ...
            if dr:
                ...
                if key == "g":
                    ...
                    flags.down_gravity_comp = True
                    print("\n[KEYBOARD] Gravity compensation ENABLED")

                elif key == "e":
                    flags.down_gravity_comp = False
                    print("\n[KEYBOARD] Gravity compensation DISABLED")
...
# scissors
NONE_ABS_POLICY_ROOT = "~/Desktop/lerobot_restore/lerobot/outputs/train/real_scissors-dp3-none-abs_seed0/checkpoints/latest.ckpt"  # for loading policy config and checkpoints
GOAL_ABS_POLICY_ROOT = "~/Desktop/lerobot_restore/lerobot/outputs/train/real_scissors-dp3-goal-abs_seed0/checkpoints/latest.ckpt"
...
# spraybottle
GOAL_ABS_PRETRAIN_POLICY = "~/Desktop/lerobot_restore/lerobot/outputs/train/real_scissors-dp3-finetune-dummyaa_seed0/checkpoints/latest.ckpt"

# syringe
DEFAULT_DATASET_ROOT = Path(
    "~/.cache/huggingface/lerobot/YingYuan0414/scissors_0520_1"
).expanduser()
# spraybottle
# DEFAULT_DATASET_ROOT = Path(
...
def main() -> None:
    ...
    if args.use_goal_condition:
        num_classes = 16 * 3 + 1
        high_level_ckpt = '/home/leap/Desktop/lerobot_restore/lerobot/outputs/train/scissors_high_level_0520/dp3_epoch_28.pt'
    ...
    _smoothed_eef   = None
    RUN_ACT_STEPS = 4
    GRAVITY_BIAS_Z_DOWN = -0.005  # +0.01   # tune empirically  
    GRAVITY_BIAS_Z = +0.02   # tune empirically
        ...
        for idx in range(0, 50 * len(actions), RUN_ACT_STEPS):
            ...
            for a_t in range(RUN_ACT_STEPS):
                ...
                if args.use_relative:
                    ...
                    if flags.gravity_comp or flags.down_gravity_comp:
                        GAIN = 1.6                                                                                                                                                                                                                                                                                                                                                                                                                                              
                    policy_action = torch.from_numpy(policy_action)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                    ...
                    if flags.gravity_comp:
                        policy_action[6:9][2] += GRAVITY_BIAS_Z
                    if flags.down_gravity_comp:
                        policy_action[6:9][2] += GRAVITY_BIAS_Z_DOWN
                # -------------------------------------------
