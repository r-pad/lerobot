...
- Per-camera separate RGB encoders
...
- Per-camera encoders and multiview support
...
- Thanks to Tony Zhao, Zipeng Fu and colleagues for [ACT / ALOHA](https://tonyzhaozh.github.io/aloha) and [Mobile ALOHA](https://mobile-aloha.github.io).
- Thanks to Cheng Chi, Zhenjia Xu and colleagues for [Diffusion Policy](https://diffusion-policy.cs.columbia.edu) and [UMI Gripper](https://umi-gripper.github.io).
- Thanks to Nicklas Hansen, Yunhai Feng and colleagues for [TD-MPC](https://github.com/nicklashansen/tdmpc).
- Thanks to Seungjae (Jay) Lee, Mahi Shafiullah and colleagues for [VQ-BeT](https://sjlee.cc/vq-bet/).
